...
class OwnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create owner" do
    assert_difference('Owner.count') do
      post owners_url, params: { owner: { blog_id: @owner.blog_id, user_id: @owner.user_id } }
    end
  ...
  test "should update owner" do
    patch owner_url(@owner), params: { owner: { blog_id: @owner.blog_id, user_id: @owner.user_id } }
